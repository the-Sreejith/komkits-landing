          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-background/50 p-1 pr-2 backdrop-blur-sm">
              <div className="flex -space-x-2 pl-2">
                {[
                  "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=64&h=64&dpr=2&q=80",
                  "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=64&h=64&dpr=2&q=80",
